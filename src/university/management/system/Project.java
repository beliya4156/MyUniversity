...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/third.png"));
        Image i3 = ic.getImage().getScaledInstance(900, 600,Image.SCALE_DEFAULT);
